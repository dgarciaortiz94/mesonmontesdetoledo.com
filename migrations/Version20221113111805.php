 ...
 */
final class Version20221113111805 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE new_user_notification (id INT AUTO_INCREMENT NOT NULL, new_user_id INT NOT NULL, creation_date DATETIME NOT NULL, is_viewed TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_53BAD8087C2D807B (new_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE user_blocked_notification (id INT AUTO_INCREMENT NOT NULL, user_blocked_id INT NOT NULL, creation_date DATETIME NOT NULL, is_viewed TINYINT(1) NOT NULL, INDEX IDX_83992B0B869897DA (user_blocked_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE user_blocked_notification_user (user_blocked_notification_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_3239F78BA76ED395 (user_id), INDEX IDX_3239F78B95B7FCDB (user_blocked_notification_id), PRIMARY KEY(user_blocked_notification_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
